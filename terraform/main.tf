...
resource "exoscale_sks_nodepool" "my_sks_nodepool" {
  ...
  size          = 3
  security_group_ids = [
  exoscale_security_group.keystore_v1_security_group.id]
}
...
resource "exoscale_security_group" "keystore_v1_security_group" {
  name = "keystore_v1-security-group"
}

resource "exoscale_security_group_rule" "kubelet" {
  security_group_id = exoscale_security_group.keystore_v1_security_group.id
  description       = "Kubelet"
  type              = "INGRESS"
  protocol          = "TCP"
  start_port        = 10250
  ...
  user_security_group_id = exoscale_security_group.keystore_v1_security_group.id
}
